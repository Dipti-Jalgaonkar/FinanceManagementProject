...
import { createKyc, uploadFile, kycProfile } from "@/libs/user";
...
const KYC: React.FC = () => {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        if(!dob) {
            setSubmitting(false)
            setErrorMsg("Please select you date of birth")
        }
                ...
                <main className="min-h-screen bg-white text-gray-900 dark:bg-[#0a0a0a] dark:text-white">
                    ...
                    <div className="mx-auto flex max-w-7xl items-center justify-between px-4 pt-6 sm:px-6 lg:px-8">
                        <div className="flex items-center gap-2">
                            <Link
                                to="/dashboard"
                                className="inline-flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-3 py-1.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 dark:border-white/10 dark:bg-white/5 dark:text-white"
                            >
                        ...
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
                            ...
                            <aside className="lg:col-span-4">
                                ...
                                <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-white/5">
                                    ...
                                    <div className="mt-4 rounded-xl border border-dashed border-gray-300 p-3 text-xs text-gray-600 dark:border-white/10 dark:text-white/60">
                                        <p>
                                            Submit your legal name, date of
                                            birth, ID type, and a photo/scan of
                                            your ID.
                                        </p>
                                        <ul className="mt-2 list-inside list-disc space-y-1">
                                            <li>
                                                Name must match your government
                                                ID.
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                Accepted IDs: National ID,
                                                Driver&apos;s License, Passport.
                                            </li>
                                            <li>
                                                Image should be clear, full
                                                document, no glare.
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="mt-4 rounded-2xl border border-gray-200 bg-gray-50 p-3 text-xs text-gray-700 dark:border-white/10 dark:bg-black/40 dark:text-white/80">
                                        <div className="flex items-start gap-2">
                                            ...
                                            <p>
                                                ...
                                                of KYC metadata. Your
                                                verification status will show as{" "}
                            ...
                            <section className="lg:col-span-8">
                                <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-white/10 dark:bg-white/5">
                                    ...
                                    <form className="space-y-5" noValidate onSubmit={handleSubmit}>
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full rounded-xl border border-gray-300 bg-white px-9 py-2 text-sm text-gray-900 placeholder:text-gray-400 outline-none ring-0 transition focus:border-gray-400 dark:border-white/10 dark:bg-transparent dark:text-white"
                                                />
                                            </div>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                            <div>
                                                ...
                                                <p className="mt-1 text-[11px] text-gray-500 dark:text-white/60">
                                                    Your model expects a string.
                                                    Upload to your storage and
                                            ...
                                            <div className="rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-white/10 dark:bg-black/40">
                                                ...
                                                <div className="mt-2 overflow-hidden rounded-xl border border-gray-200 dark:border-white/10">
                                                    <div className="grid h-48 place-items-center text-xs text-gray-500 dark:text-white/50">
                                                        {idImageUrl? <img src={idImageUrl} alt="ID Preview" className="h-48 w-full object-contain"/>: "No image selected"}
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="flex flex-col items-stretch justify-between gap-3 sm:flex-row sm:items-center">
                                            <div className="text-xs text-gray-600 dark:text-white/60">
                                                Submissions are reviewed within
                                                24–72 hours.
                                            </div>
                                            <div className="flex gap-2">
                                                ...
                                                <button
                                                    type="button"
                                                    className="inline-flex items-center justify-center gap-2 rounded-xl bg-gray-900 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:opacity-95 dark:bg-white dark:text-black"
                                                >
                                ...
                                <div className="mt-6 rounded-2xl border border-gray-200 bg-gray-50 p-4 text-xs text-gray-600 dark:border-white/10 dark:bg-black/40 dark:text-white/60">
                                    If you already submitted KYC and need
                                    corrections, please contact support.
                                    Duplicate submissions aren’t allowed.
                                </div>
                            </section>
                        </div>
                    </div>
