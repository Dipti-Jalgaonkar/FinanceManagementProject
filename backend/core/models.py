...
class Beneficiary(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name ="benificiaries")
    beneficiary_user = models.ForeignKey(settings.AUTH.USER.MODEL, on_delete=models.CASCADE, related_name="benefactors")
...
class Transaction(models.Model):
    ...
    external_reference = models.CharField(max20, blank=True, null=True)
...
class SavingsGoal(models.Model):
    wallet = models.ForeignKey(Wallet, on_delete=models.CASCADE, related_name='savings_goal')
